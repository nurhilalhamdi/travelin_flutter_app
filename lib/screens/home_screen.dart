    ...
    return Scaffold(
      ...
      body: Container(
        child: ListView(
          ...
          children: <Widget>[
            //Promo Section
            Padding(padding: EdgeInsets.only(left: 16, bottom: 24),
              child: Text('Hi, User 👋 This Promo For You!',
                style: mTitleStyle,
              ),
            ),
            Container(
            ...
            //Service Section
            Padding(padding: EdgeInsets.only(left: 16,top: 24, bottom: 12),
                    ...
                    children: <Widget>[
                              ...
                              Padding(padding: EdgeInsets.only(left: 16),
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text('Feel Freedom', style: mServiceSubTitleStyle,)
                                  ],
                                ),
                              ),
                            ],
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              SvgPicture.asset('assets/svg/service_tourguide_icon.svg',
                                fit: BoxFit.contain,
                              ),
                              Padding(padding: EdgeInsets.only(left: 16),
                                child: Column(
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: <Widget>[
                                    Text('Tour Guide', style: mServiceTitleStyle,),
                                    Text('Feel Safety', style: mServiceSubTitleStyle,)
                                  ],
                                ),
                              ),
                            ],
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              SvgPicture.asset('assets/svg/service_hotel_icon.svg',
                                fit: BoxFit.contain,
                              ),
                              Padding(padding: EdgeInsets.only(left: 16),
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text('Lets take a break', style: mServiceSubTitleStyle,)
                                  ],
                                ),
                              ),
                            ],
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              SvgPicture.asset('assets/svg/service_car_icon.svg',
                                fit: BoxFit.contain,
                              ),
                              Padding(padding: EdgeInsets.only(left: 16),
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text('Around the city', style: mServiceSubTitleStyle,)
                                  ],
                                ),
                              ),
                            ],
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(populars[index].daerah, style: mPopularDestinationSubTitleStyle,)
                          ],
                        ),
                      ),
                    ),
